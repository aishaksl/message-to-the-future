      ...
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-2 md:gap-4 max-w-7xl mx-auto">
        <div className="contents">
              ...
              <div className="relative z-10 w-28 h-28 bg-white/25 border border-white/30 rounded-2xl flex items-center justify-center shadow-md">
                <div className="flex flex-col gap-2 items-center">
                  <div className="flex items-center gap-1 px-2 py-1 rounded-xl bg-white/30 border border-white/40 transition-all duration-300">
                    ...
                    <div className="text-xs text-slate-600">Myself</div>
                  </div>
                  <div className="flex items-center gap-1 px-2 py-1 rounded-xl bg-indigo-500/20 border border-indigo-500 transition-all duration-300">
                    ...
                    <div className="text-xs text-indigo-600">Someone</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="relative z-10 w-28 h-28 bg-white/25 border border-white/30 rounded-2xl flex items-center justify-center shadow-md">
                <div className="grid grid-cols-2 gap-2">
                  <div className="bg-indigo-500/20 border border-indigo-500 rounded-md flex items-center justify-center transition-all duration-300 transform scale-110 shadow-lg shadow-indigo-500/30">
                    <BookOpenText size={32} strokeWidth={1.25} className="p-1" />
                  </div>
                  <Video color="#6366F1" size={28} strokeWidth={1.25} />
                  <AudioLines color="#6366F1" size={28} strokeWidth={1.25} />
                  <Image color="#6366F1" size={28} strokeWidth={1.25} />
                </div>
              </div>
            </div>

            <div className="relative z-10">
              <div className="inline-flex items-center justify-center w-6 h-6 bg-[#9475f3] text-white rounded-full text-sm font-bold mb-1 md:mb-2">3</div>
              ...
              <p className="hidden md:block text-sm text-slate-600 font-light">Choose the type of content: text, video, audio, or image</p>
            </div>
          </div>
          ...
          <div className="group px-3 pt-6 md:p-6 transition-all duration-300 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="inline-flex items-center justify-center w-6 h-6 bg-[#9475f3] text-white rounded-full text-sm font-bold mb-1 md:mb-2">4</div>
              ...
              <p className="hidden md:block text-sm text-slate-600 font-light">Upload your files or write your message content</p>
            </div>
          </div>
        </div>
        ...
        <div className="group px-3 pt-6 md:p-6 transition-all duration-300 text-center relative overflow-hidden">
          <div className="h-16 md:h-32 relative mb-1 md:mb-3 flex items-center justify-center">
            <div className="relative z-10 w-28 h-28 bg-white/25 border border-white/30 rounded-2xl flex items-center justify-center shadow-md">
              <div className="w-16 h-16 bg-white/20 rounded-xl flex flex-col items-center justify-center gap-1">
                ...
                <CalendarHeart size={28} color="#6366F1" strokeWidth={1.25} />
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center justify-center w-6 h-6 bg-[#9475f3] text-white rounded-full text-sm font-bold mb-1 md:mb-2">5</div>
            ...
            <p className="hidden md:block text-sm text-slate-600 font-light">Choose when your message should be delivered</p>
          </div>
        </div>
      </div>
    </div>
