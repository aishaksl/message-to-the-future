...
const HowItWorksSection: React.FC = () => {
  return (
    <div className="h-full flex flex-col justify-center">
      ...
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4 max-w-7xl mx-auto">
        <div className="contents">
          {/* First 4 cards in normal grid flow */}
        {/* Step 1: Choose Recipient */}
        <div className="group bg-white rounded-xl p-4 md:p-6 shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 text-center relative overflow-hidden">
          {/* ... existing step 1 content ... */}
          <div className="h-20 md:h-32 relative mb-2 md:mb-3 flex items-center justify-center">
        ...
        <div className="group bg-white rounded-xl p-4 md:p-6 shadow-md border border-gray-100 hover:shadow-lg transition-all duration-300 text-center relative overflow-hidden">
          <div className="h-20 md:h-32 relative mb-2 md:mb-3 flex items-center justify-center">
            <div className="relative z-10 w-24 h-24 bg-white/25 backdrop-blur-md border border-white/30 rounded-2xl flex items-center justify-center shadow-lg">
        ...
        {/* Step 3: Content Type */}
        <div className="group bg-white rounded-xl p-4 md:p-7 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 text-center relative overflow-hidden">
          <div className="h-20 md:h-32 relative mb-2 md:mb-3 flex items-center justify-center">
            <div className="relative z-10 w-24 h-24 bg-white/25 backdrop-blur-md border border-white/30 rounded-2xl flex items-center justify-center shadow-lg">
        ...
        {/* Step 5: Set Schedule - Centered on mobile */}
        <div className="col-span-2 md:col-span-1 lg:col-span-1 xl:col-span-1 mx-auto max-w-sm md:max-w-none group bg-white rounded-xl p-4 md:p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 text-center relative overflow-hidden">
          <div className="h-20 md:h-32 relative mb-2 md:mb-3 flex items-center justify-center">
            <div className="relative z-10 w-24 h-24 bg-white/25 backdrop-blur-md border border-white/30 rounded-2xl flex items-center justify-center shadow-lg">
