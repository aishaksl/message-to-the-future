  ...
  return (
    <div className="relative">
      ...
      <section className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/30 relative overflow-hidden flex items-center justify-center">
        ...
        <div className="absolute w-24 h-24 rounded-full bg-gradient-to-br from-pink-200 to-orange-300 bottom-32 right-16 opacity-50" style={{ borderRadius: '60% 40% 30% 70%' }}></div>
